...
parentRock | Underlying geological material (generally bedrock or a superficial or drift deposit) in which soil horizons form. | 0..n | No |
...
relativePlotPosition | Position, relative to the plot origin, of the organism within the plot. This position is assumed to be constant in time during the organism lifespan. | 0..1 | No |
