...
The following table provides the description of the main elements of Veg-X (column 'R' indicates whether the sub-elements are currently implemented in the **VegX R package**):
...
abstract                  | Project abstract.  | 0..1 | Yes |
...
designDescription         | Description of the design of the research project | 0..1 | Yes |
relatedProjectID          | A link to another project, by ID.                 | 0..n | No  |

### Element *party*

A *party* element describes a responsible party (person, organization or a position), and is typically used to name the originator of a resource or metadata document.
...
placementPartyID | The ID of a party that undertook the plot placement. | 0..n | Yes |
placementNote | TO BE DONE | 0..n | No |
