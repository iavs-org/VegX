...
originalIdentificationReferencePublicationID  | A link, by ID, to the publication (e.g. flora manual) used as reference to identify organisms by the author of the data set, or stated by a third party. Ideally, this publication should include definitions of taxon concepts.
...
#### Naming organisms when displaying observations
