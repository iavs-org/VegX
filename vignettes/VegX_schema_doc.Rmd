...
siteObservation             | A container for all the site observations made on a single Plot during a single date-time period. |
surfaceCover | TO BE DONE |
surfaceCoverObservation | TO BE DONE |
vegetationObservation | TO BE DONE |
...
communityConcept | A name and some kind of definition of a community type, preferably a community name as used in a reference. |
communityDetermination | An identification applying one or more CommunityConcepts to a plotObservation by a party.|
...
Sub-element (qualitative)      | Description                                         |  R obj. |
------------------------ | --------------------------------------------------- | ------- |
...
Sub-element (ordinal)      | Description                                         |  R obj. |
------------------------ | --------------------------------------------------- | ------- |
...
Sub-element (quantitative)      | Description                                         |  R obj. |
------------------------ | --------------------------------------------------- | ------- |
...
taxonNameUsageConceptID  | A reference to a specific datasetNameUsageConcept representing a taxon occurrence. | Yes |
