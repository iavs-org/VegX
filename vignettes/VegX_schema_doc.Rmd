...
Veg-X has a non-hierarchical data structure. Different data elements relate to each other via identifiers in a flexible way. The following figure illustrates the relationships between the main elements.
...
individualOrganismObservation  | An observation applying to one occurrence of an organism (or part of an organism).  |
