...
output: 
  rmarkdown::html_vignette:
    toc: TRUE
vignette: >
  %\VignetteIndexEntry{How to use the VegX R package}
...
```{r count scale def}
countscale = predefinedMeasurementMethod("Plant count/individuals")
```
