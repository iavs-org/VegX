...
#'  \item mtfyffe_counts Observations of counts of taxon categories, grouped by vegetation strata (543 records x 30 variables)
...
#'  \item taki_site Site characteristics of plots/subplots (325 records x 29 variables)
